...
| **SKILL.md** | `skills/cora-idea-status/SKILL.md` |
...
Lifecycle sibling of [cora-project-status](cora-project-status.md).
Ideas first arrive via [cora-logger](cora-logger.md).
