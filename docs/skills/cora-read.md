...
| **Command** | `/cora-read` |
| **Mode** | Read-only |
| **SKILL.md** | `skills/cora-read/SKILL.md` |
...
The full-content complement to [cora-find](cora-find.md)'s snippets.
Pair with [cora-edit](cora-edit.md) when you want to change what you
read.
