...
Use the `cora-edit` skill to apply a surgical edit to content that
...
- `/cora-edit fix the typo in agentwatch STYLE.md`
- `/cora-edit reword the brand profile intro`
...
entry in the log. For *new* knowledge, use `/cora-log` instead.
